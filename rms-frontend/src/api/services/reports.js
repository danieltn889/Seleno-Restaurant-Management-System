...
export const getSalesReport = async (params = {}) => {
  try {
    ...
    const url = `/reports/sales.php${queryParams.toString() ? `?${queryParams.toString()}` : ""}`;
...
export const getInventoryReport = async () => {
  try {
    const response = await api.get("/reports/inventory.php");
    return response.data;
  } catch (error) {
    return handleError(error);
  }
...
export const getStockMovementReport = async (params = {}) => {
  try {
    ...
    const url = `/reports/stock-movement.php${queryParams.toString() ? `?${queryParams.toString()}` : ""}`;
    const response = await api.get(url);
    return response.data;
  } catch (error) {
    return handleError(error);
...
export const getOrderReport = async (params = {}) => {
  try {
    ...
    const url = `/reports/orders.php${queryParams.toString() ? `?${queryParams.toString()}` : ""}`;
    const response = await api.get(url);
    return response.data;
  } catch (error) {
    return handleError(error);
...
export const getPaymentReport = async (params = {}) => {
  try {
    ...
    const url = `/reports/payments.php${queryParams.toString() ? `?${queryParams.toString()}` : ""}`;
    const response = await api.get(url);
    return response.data;
  } catch (error) {
    return handleError(error);
...
export const getUserActivityReport = async (params = {}) => {
  try {
    ...
    const url = `/reports/user-activity.php${queryParams.toString() ? `?${queryParams.toString()}` : ""}`;
    const response = await api.get(url);
    return response.data;
  } catch (error) {
    return handleError(error);
